...
client.on('message', async (message) => {
  ...
  if (matched) {
    if (message.member.hasPermission('KICK_MEMBERS')) return; // Here, you can change the permission to ADMININISTRATOR, BAN_MEMBERS, MANAGE_MESSAGES or something else!
    message.delete();
